...
import { editEmployee, getEmployeeById } from "../../../services/firebase_employee_services";
...
export default function EditEmployee() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await editEmployee(id, employeeDetails);
        ...
        <div className="modal-content">
          ...
          <form className="new-employee-form" onSubmit={handleSubmit}>
            <div className="new-employee-form-fields">
              <label className="new-employee-form-field-label">
                First Name:
              </label>
              <br />
              <input
